...
"@
        ...
        "BtnBorrarCacheArmeria"       = "Borrar cache"
        "BtnUtilidades"               = "Utilidades"
        "TituloMods"                  = "Mods del servidor"
        "MsgModsInfo"                 = "En cada conf pon # @PANEL_TOGGLE encima de la linea Enable. El boton respeta 0/1 o true/false. Reinicia el worldserver."
        "LblModsCarpeta"              = "Carpeta:"
        "MsgModsConfNoDir"            = "No se encontro la carpeta configs\modules. Configura la ruta del worldserver."
        "MsgModsSinEnable"            = "No se encontro # @PANEL_TOGGLE ni una clave Enable/Enabled."
        "MsgModsSinClave"             = "Sin @PANEL_TOGGLE / Enable detectado"
        "MsgModsVacio"                = "No hay archivos .conf en la carpeta de modules."
        "BtnModOn"                    = "ON"
        "BtnModOff"                   = "OFF"
        "BtnActualizar"               = "Actualizar"

        "TituloUtilidades"            = "Utilidades servidor"
        "MsgUtilidadesInfo"           = "Lanza herramientas externas. Configura la ruta de cada .exe una vez."
        "BtnKeira"                    = "Keira3"
        "DescKeira"                   = "Editor visual de la base de datos del mundo (criaturas, objetos, quests, hechizos...)."
        "DescTrinityCreator"          = "Crea y edita items, NPCs, quests y contenido personalizado para el emulador."
        "DescHeidi"                   = "Gestor MySQL: consultar, editar y administrar las bases auth, characters y world."
        "BtnPanelGuiFondo"            = "Cambiar fondo del panel principal..."
        "MsgPanelGuiFondoHint"        = "O coloca Imagenes\panel_bg.png en la carpeta del panel."
        "TituloSelFondoPanel"         = "Imagen de fondo del panel principal"
        "MsgFondoPanelGuardado"       = "Fondo guardado. Se aplicara al reiniciar el panel principal."

        "BtnTrinityCreator"           = "Trinity Creator"
        "BtnHeidi"                    = "HeidiSQL"
        "BtnConfigRuta"               = "Ruta..."
        "BtnUtilidadesFondo"          = "Cambiar imagen de fondo..."
        "MsgUtilidadesFondoHint"      = "Tambien puedes poner Imagenes\utilidades_bg.png en la carpeta del panel."
        "MsgRutaNoCfg"                = "(sin ruta)"
        "MsgUtilExeNoConfig"          = "No hay ruta configurada para {0}.`nUsa el boton de configurar ruta."
        "MsgUtilExeError"             = "No se pudo abrir {0}:`n{1}"
        "TituloSelKeira"              = "Seleccionar Keira (.exe)"
        "TituloSelTrinity"            = "Seleccionar Trinity Creator (.exe)"
        "TituloSelHeidi"              = "Seleccionar HeidiSQL (.exe)"
        "TituloSelFondoUtil"          = "Imagen de fondo del panel Utilidades"

        "TituloBorrarCacheArmeria"    = "Borrar cache Armeria"
        "MsgCacheArmeriaNoExiste"     = "No se encontro la carpeta de cache Armeria.`n`nRuta esperada:`n{0}"
        "MsgCacheArmeriaBorrada"      = "Cache de Armeria eliminada correctamente.`n`nSe regenerara al usar Armeria / Transmog / Establos."
        "MsgCacheArmeriaError"        = "No se pudo borrar la carpeta:`n{0}"
        "MsgConfirmarBorrarCacheArmeria" = "ATENCION: Se eliminara TODA la carpeta de cache de la Armeria:`n`n  {0}`n`nSe borraran (si existen):`n  - Iconos descargados (items, UI, spells...)`n  - Capturas de pantalla de Wowhead (screenshots)`n  - Fondos de talentos / PvP`n  - Cache JSON de personajes`n  - Tooltips y datos temporales`n`nNO se borran los iconos personalizados del panel en:`n  Imagenes\menu\  y  Imagenes\armeria\`n`nSi has puesto iconos o fondos DENTRO de Scripts\Armeria\, haz una copia de seguridad antes.`n`n¿Seguro que quieres continuar?"
...
"@
        ...
        "BtnBorrarCacheArmeria"       = "Clear cache"
        "BtnUtilidades"               = "Utilities"
        "TituloMods"                  = "Server mods"
        "MsgModsInfo"                 = "In each conf put # @PANEL_TOGGLE above the Enable line. The button keeps 0/1 or true/false. Restart worldserver."
        "LblModsCarpeta"              = "Folder:"
        "MsgModsConfNoDir"            = "Could not find configs\modules. Set the worldserver path in config."
        "MsgModsSinEnable"            = "No # @PANEL_TOGGLE or Enable/Enabled key found."
        "MsgModsSinClave"             = "No @PANEL_TOGGLE / Enable detected"
        "MsgModsVacio"                = "No .conf files in the modules folder."
        "BtnModOn"                    = "ON"
        "BtnModOff"                   = "OFF"
        "BtnActualizar"               = "Refresh"

        "BtnKeira"                    = "Keira3"
        "DescKeira"                   = "Visual world database editor (creatures, gameobjects, quests, spells...)."
        "DescTrinityCreator"          = "Create and edit items, NPCs, quests and custom content for the emulator."
        "DescHeidi"                   = "MySQL manager: query, edit and administer auth, characters and world databases."
        "BtnPanelGuiFondo"            = "Change main panel background..."
        "MsgPanelGuiFondoHint"        = "Or place Imagenes\panel_bg.png in the panel folder."
        "TituloSelFondoPanel"         = "Main panel background image"
        "MsgFondoPanelGuardado"       = "Background saved. It will apply when you restart the main panel."

        "TituloUtilidades"            = "Server utilities"
        "MsgUtilidadesInfo"           = "Launch external tools. Set each .exe path once."
        "BtnTrinityCreator"           = "Trinity Creator"
        "BtnHeidi"                    = "HeidiSQL"
        "BtnConfigRuta"               = "Path..."
        "BtnUtilidadesFondo"          = "Change background image..."
        "MsgUtilidadesFondoHint"      = "You can also place Imagenes\utilidades_bg.png in the panel folder."
        "MsgRutaNoCfg"                = "(no path)"
        "MsgUtilExeNoConfig"          = "No path configured for {0}.`nUse the path button to set it."
        "MsgUtilExeError"             = "Could not open {0}:`n{1}"
        "TituloSelKeira"              = "Select Keira (.exe)"
        "TituloSelTrinity"            = "Select Trinity Creator (.exe)"
        "TituloSelHeidi"              = "Select HeidiSQL (.exe)"
        "TituloSelFondoUtil"          = "Utilities panel background image"

        "TituloBorrarCacheArmeria"    = "Clear Armory cache"
        "MsgCacheArmeriaNoExiste"     = "Armory cache folder not found.`n`nExpected path:`n{0}"
        "MsgCacheArmeriaBorrada"      = "Armory cache deleted successfully.`n`nIt will be rebuilt when you use Armory / Transmog / Stables."
        "MsgCacheArmeriaError"        = "Could not delete the folder:`n{0}"
        "MsgConfirmarBorrarCacheArmeria" = "WARNING: The entire Armory cache folder will be deleted:`n`n  {0}`n`nThis removes (if present):`n  - Downloaded icons (items, UI, spells...)`n  - Wowhead screenshots`n  - Talent / PvP backgrounds`n  - Character JSON cache`n  - Tooltips and temporary data`n`nCustom panel icons are NOT deleted:`n  Imagenes\menu\  and  Imagenes\armeria\`n`nIf you placed icons or backgrounds INSIDE Scripts\Armeria\, back them up first.`n`nAre you sure you want to continue?"
